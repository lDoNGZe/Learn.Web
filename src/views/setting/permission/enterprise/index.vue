    ...
    <div class="left-tree-box">
      ...
      <div class="tree-content">
        ...
        >
          ...
          >
            <el-button
              v-auth="['eprPermission.btn.editRole']"
              type="text"
              size="mini"
              @click="editGroup(tree)"
            >编辑</el-button>
            <el-button
              v-auth="['eprPermission.btn.deleteRole']"
              type="text"
              size="mini"
      ...
      <div class="bot-btn">
        <el-button
          v-auth="['eprPermission.btn.addRole']"
          type="text"
          icon="el-icon-plus"
          @click="addGroup"
        >新建角色</el-button>
      ...
      >
        <div class="base-form">
          ...
          >
            ...
            ></el-input>
            <el-tree
              style="width: 400px; height: 340px; overflow-x: hidden; overflow-y: auto;"
              show-checkbox
              class="filter-tree"
              :data="userList"
              :props="defaultProps"
